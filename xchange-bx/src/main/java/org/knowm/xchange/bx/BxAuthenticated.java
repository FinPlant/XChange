...
public interface BxAuthenticated extends Bx {
    ...
    @POST
    @Path("order/")
    BxCreateOrderResult createOrder(@FormParam("pairing") String pairId,
    ...
    @POST
    @Path("cancel/")
    BxCancelOrderResult cancelOrder(@FormParam("pairing") String pairId,
    ...
    @POST
    @Path("history/")
    BxTradeHistoryResult getTradeHistory(@FormParam("currency") String currency,
    ...
    @POST
    @Path("getorders/")
    BxOrdersResult getOrders(@FormParam("pairing") String pairId,
                             @FormParam("type") String orderType,
                             @FormParam("key") String apiKey,
                             @FormParam("nonce") SynchronizedValueFactory<Long> nonce,
                             @FormParam("signature") ParamsDigest signature) throws IOException;
