...
public class BxBalance {
    ...
    public BxBalance(@JsonProperty("total") BigDecimal total, @JsonProperty("available") BigDecimal available,
                     @JsonProperty("orders") BigDecimal orders, @JsonProperty("withdrawals") BigDecimal withdrawals,
                     @JsonProperty("deposits") BigDecimal deposits, @JsonProperty("options") BigDecimal options) {
        this.total = total;
